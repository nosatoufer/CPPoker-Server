...
QT_MOC_LITERAL(3, 25, 18), // "ConnectionManager*"
QT_MOC_LITERAL(4, 44, 2), // "cm"
QT_MOC_LITERAL(5, 47, 18) // "clientDisconnected"

    },
    "RoomManager\0readRequest\0\0ConnectionManager*\0"
...
void RoomManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RoomManager *_t = static_cast<RoomManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject RoomManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RoomManager.data,
      qt_meta_data_RoomManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RoomManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RoomManager.stringdata0))
        return static_cast<void*>(const_cast< RoomManager*>(this));
